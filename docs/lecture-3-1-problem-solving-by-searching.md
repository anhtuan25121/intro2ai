---
layout: default
title: Lecture 3.1 - Problem Solving by Searching
---

# Lecture 3.1 — Problem Solving by Searching

> Không thuộc phạm vi thi giữa kì (chỉ Lecture 5). Nền tảng quan trọng cho [Lecture 3.2 - Uninformed Search](lecture-3-2-uninformed-search.md) và [Lecture 3.3 - Informed Search](lecture-3-3-informed-search.md).

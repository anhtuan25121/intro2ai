---
layout: default
title: Đề thi tham khảo - Adversarial Search
---

# 📝 Đề thi tham khảo — Adversarial Search

> Bộ bài tập luyện tập cho phần thi giữa kì ([Lecture 5](lecture-5-adversarial-search.md)). Mỗi bài đều có **lời giải chi tiết** ngay bên dưới — hãy tự làm trước khi xem đáp án.
...
1. **Tự soạn mới, tự kiểm chứng từng bước** (đảm bảo đúng 100%, bám sát đúng công thức trong [Lecture 5](lecture-5-adversarial-search.md))
...
2. Một agent chơi cờ vua chỉ có 1 giây suy nghĩ mỗi nước. Nên ưu tiên cải thiện **move ordering** hay tăng **độ sâu cutoff**? Giải thích bằng công thức complexity.
...
5. Vì sao Adversarial Search không thể áp dụng thuật toán **Hill-Climbing** ([Lecture 4](lecture-4-local-search-algorithms.md)) để chọn nước đi?

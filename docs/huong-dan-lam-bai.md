---
layout: default
title: Hướng dẫn làm bài & Trình bày
---
...
3. Với mỗi node trung gian, viết: `Tên_node (MAX/MIN) = max/min(giá trị con 1, giá trị con 2, ...) = <kết quả>`
...
→ Xem ví dụ mẫu ở [Đề thi tham khảo](de-thi-tham-khao.md) Bài 1, Bài 2 (phần a).
...
- Nhầm chiều bất đẳng thức giữa node MAX và MIN (lỗi phổ biến nhất — xem lại [Cheat Sheet](cheat-sheet-adversarial-search.md) mục "Bẫy thường gặp").
- Duyệt sai thứ tự (phải-trái thay vì trái-phải) khi đề không yêu cầu khác.

→ Xem ví dụ mẫu có trace từng bước ở [Đề thi tham khảo](de-thi-tham-khao.md) Bài 2 (phần b), Bài 3.
...
→ Xem bộ câu hỏi mẫu ở [Đề thi tham khảo](de-thi-tham-khao.md) Bài 5, Bài 6 và phần "Câu hỏi tự kiểm tra nhanh" cuối [Lecture 5](lecture-5-adversarial-search.md).
...
2. Tại node CHANCE, **viết rõ từng số hạng** của tổng kỳ vọng, không rút gọn: `CHANCE = P(kq_1)×giá_trị_1 + P(kq_2)×giá_trị_2 + ... = (0.5×2)+(0.5×4) = 1+2 = 3`
...
→ Xem ví dụ mẫu ở [Đề thi tham khảo](de-thi-tham-khao.md) Bài 4.
...
→ Bảng số liệu đầy đủ ở [Cheat Sheet](cheat-sheet-adversarial-search.md) mục 7.
...
- [Lecture 5 - Adversarial Search](lecture-5-adversarial-search.md) — lý thuyết đầy đủ
- [Cheat Sheet](cheat-sheet-adversarial-search.md) — tóm tắt nhanh + bẫy thường gặp
- [Đề thi tham khảo](de-thi-tham-khao.md) — bài tập luyện tập kèm lời giải mẫu đúng format
- [Lộ trình học & Liên kết kiến thức](lo-trinh-hoc.md) — hiểu bối cảnh tổng thể môn học

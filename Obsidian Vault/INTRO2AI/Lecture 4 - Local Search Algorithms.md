...
- [[Lecture 5 - Adversarial Search]] — vì sao Adversarial Search **không thể** dùng cách tiếp cận local search (không dự đoán được phản ứng của đối thủ) — xem [[Đề thi tham khảo - Adversarial Search]] Bài 6, câu 5 (nội dung thi)

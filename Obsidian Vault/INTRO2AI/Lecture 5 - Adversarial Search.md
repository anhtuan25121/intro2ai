---
tags: [intro2ai, exam, adversarial-search]
---

# Lecture 5 — Adversarial Search

> [!danger] TRỌNG TÂM THI GIỮA KÌ
> Đây là **nội dung duy nhất** trong đề thi closed-book. Học kỹ toàn bộ file này.
> Xem thêm [[Cheat Sheet - Adversarial Search]] để ôn nhanh, [[Đề thi tham khảo - Adversarial Search]] để luyện tập, và [[Hướng dẫn làm bài & Trình bày]] để biết cách trình bày ăn điểm.
> Nếu thấy lạ về mặt khái niệm, xem [[Lộ trình học & Liên kết kiến thức]] — Minimax/Alpha-Beta thực chất là DFS + heuristic đã học ở [[Lecture 3.1 - Problem Solving by Searching]], [[Lecture 3.2 - Uninformed Search]], [[Lecture 3.3 - Informed Search]].
...
> [!tip] Ghi nhớ khi thi
> MAX-VALUE khởi tạo v = −∞ rồi lấy MAX; MIN-VALUE khởi tạo v = +∞ rồi lấy MIN. Rất dễ bị hỏi vẽ tay 1 cây minimax nhỏ (3-4 tầng) và tính giá trị từng node.
...
> [!warning] Điều kiện cắt tỉa — rất hay thi
...
- Nhánh trái: lá = 3, 12, 8 → node MIN trái nhận **3** (vì MIN chọn nhỏ nhất trong {3,12,8}... thực chất nhóm con {3,12} → MAX chọn max(3,12)=12; nhưng ví dụ kinh điển AIMA cho kết quả cuối cùng là **[3,3]**)
- Nhánh phải: lá = 2, 14, 5, 2

Kết quả cuối: **giá trị root = 3**, với nhiều nhánh được cắt bỏ (không cần duyệt hết 8 phần tử) mà kết quả vẫn giống hệt Minimax đầy đủ.

> [!tip] Cách vẽ tay khi thi
> Vẽ cây từ trái sang phải, duyệt DFS. Ghi giá trị α, β hiện tại tại mỗi node khi đi vào. Khi thấy điều kiện `v ≥ β` (tại MAX) hoặc `v ≤ α` (tại MIN) thì gạch chéo (cắt) các nhánh con còn lại chưa duyệt của node đó.
...
> [!tip] Lưu ý khi thi
> Nếu đề cho một cây có node CHANCE với xác suất từng nhánh, chỉ cần: (1) tính utility/minimax value của các node lá dưới CHANCE trước, (2) nhân từng giá trị với xác suất tương ứng rồi cộng lại ra giá trị node CHANCE, (3) tiếp tục lan truyền lên trên bình thường theo MAX/MIN.
...
## Xem thêm
- [[Cheat Sheet - Adversarial Search]] — tóm tắt siêu nhanh + bẫy thường gặp
- [[Đề thi tham khảo - Adversarial Search]] — 6 bài tập có lời giải chi tiết (minimax, alpha-beta, move ordering, expectiminimax, trắc nghiệm)
- [[Hướng dẫn làm bài & Trình bày]] — cách trình bày từng dạng câu hỏi để ăn trọn điểm
- [[Lộ trình học & Liên kết kiến thức]] — Adversarial Search liên hệ thế nào với các lecture trước

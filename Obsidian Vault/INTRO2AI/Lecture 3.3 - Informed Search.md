...
> Không thuộc phạm vi thi giữa kì (chỉ Lecture 5). Xem nền tảng ở [[Lecture 3.1 - Problem Solving by Searching]] và [[Lecture 3.2 - Uninformed Search]].
...
- [[Lecture 5 - Adversarial Search]] — Evaluation function EVAL(s) (H-Minimax) là "họ hàng" của heuristic h(n) ở trên: cùng mục đích ước lượng để tránh duyệt hết cây, nhưng EVAL đo "lợi thế" còn h(n) đo "chi phí còn lại" (nội dung thi)

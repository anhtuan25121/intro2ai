...
> Không thuộc phạm vi thi giữa kì (chỉ Lecture 5). Xem nền tảng ở [[Lecture 3.1 - Problem Solving by Searching]].
...
- [[Lecture 5 - Adversarial Search]] — thuật toán **Alpha-Beta pruning chính là DFS** (mục 3 ở trên) có thêm 2 biến α, β để cắt tỉa (nội dung thi)

...
- [[Lecture 3.1 - Problem Solving by Searching]] — Goal-based agent (mục 3 ở trên) chính là điểm khởi đầu của toàn bộ chương Search
- [[Lecture 5 - Adversarial Search]] — một agent chơi game (MAX) đối đầu 1 agent khác (MIN) là dạng multi-agent, competitive environment đặc biệt (nội dung thi)
